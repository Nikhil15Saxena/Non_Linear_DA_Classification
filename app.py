...
def main():
    ...
    if uploaded_file is not None:
        ...
        if outcome_var and independent_vars:
            ...
            # Feature Importance (only for RandomForest and GBM)
            if model_selection in ['RandomForest', 'GBM']:
            ...
            if model_selection == 'RandomForest' and st.button("Show Random Forest Trees"):
